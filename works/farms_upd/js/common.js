...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if ($('.main-page').length > 0) {
    ...
    var mainRightAnimation = bodymovin.loadAnimation({
      ...
      path: './assets/docs/json/main_animation.json',
      renderer: 'svg',
      loop: false,
      autoplay: true,
      name: "main_left"
  ...
  /* preview page */
  var previewSlider = new _swiper["default"]('#preview-slider', {
    lazy: true,
    speed: 800,
    slidesPerView: 3,
    spaceBetween: 20
  });
  var previewHowSlider = new _swiper["default"]('#preview-how-slider', {
