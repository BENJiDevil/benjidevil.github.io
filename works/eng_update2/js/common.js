...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "headerFix": () => (/* binding */ headerFix),
...
const headerFix = () => {
  const headerHeight = () => {
    ...
    doc.style.setProperty('--header-height', "".concat(height, "px"));
    $('.header').next().css('margin-top', "".concat(height + 10, "px"));
  };
...
/* harmony import */ var intl_tel_input__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! intl-tel-input */ "./node_modules/intl-tel-input/index.js");
...
/* harmony import */ var green_audio_player_dist_js_green_audio_player_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! green-audio-player/dist/js/green-audio-player.js */ "./node_modules/green-audio-player/dist/js/green-audio-player.js");
/* harmony import */ var _func_nojq_heightFix_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./_func/_nojq/heightFix.js */ "./src/js/_func/_nojq/heightFix.js");
/* harmony import */ var _func_jq_humburger_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./_func/_jq/humburger.js */ "./src/js/_func/_jq/humburger.js");
// Lazysizes
...
document.addEventListener('DOMContentLoaded', () => {
  /* modile height fix */
  (0,_func_nojq_heightFix_js__WEBPACK_IMPORTED_MODULE_8__.heightFix)();
  ...
  (0,_func_nojq_heightFix_js__WEBPACK_IMPORTED_MODULE_8__.headerFix)();
  /* header scroll */
  ...
  $('.header').on('click', '.header-close', function () {
    $('.header .header__top').slideUp(400).addClass('removed'); // set choose to cookie for 1 day

    setCookie('h_info', true, {
      secure: true,
      'max-age': 86400
    });
    setTimeout(function () {
  ...
  (0,_func_jq_humburger_js__WEBPACK_IMPORTED_MODULE_9__.hamburger)('hamburger');
  /* mobile submenu */
  ...
  const cardsSlider = new swiper__WEBPACK_IMPORTED_MODULE_5__["default"]('#cards-slider', {
  ...
  section_nav();
  window.addEventListener('resize', section_nav); // learning team btns function
  ...
  function progSlider_init() {
    ...
    if (window.innerWidth >= 1200) {
      ...
      setTimeout(function () {
        programmSlider = new swiper__WEBPACK_IMPORTED_MODULE_5__["default"]('#programm-slider', {
  ...
  progSlider_init();
  window.addEventListener('resize', progSlider_init); // learning page questions
  ...
  green_audio_player_dist_js_green_audio_player_js__WEBPACK_IMPORTED_MODULE_7__.init({
  ...
  document.querySelectorAll('select.custom-select').forEach(s => {
    const customSelects = new choices_js__WEBPACK_IMPORTED_MODULE_6__(s, {
      searchEnabled: false,
      itemSelectText: ''
    });
  }); // phone select
  ...
  document.querySelectorAll('.phone-input').forEach(input => {
    var phoneInput = intl_tel_input__WEBPACK_IMPORTED_MODULE_4__(input, {
