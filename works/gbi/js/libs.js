...
},{"lazysizes":2}],5:[function(require,module,exports){
(function(window, factory) {
	if(!window) {return;}
	var globalInstall = function(){
		factory(window.lazySizes);
...
},{"lazysizes":2}],6:[function(require,module,exports){
...
window.jQuery = window.$ = jquery;
// OTHER LIBS
require('./_bower/owl.carousel/dist/owl.carousel')
*/
window.jQuery = window.$ = _jquery["default"]; // require('./_bower/wow/dist/wow');

require('./_bower/owl.carousel/dist/owl.carousel'); // require('./_bower/slick-carousel/slick/slick');


require('./_bower/magnific-popup/dist/jquery.magnific-popup');

},{"./_bower/magnific-popup/dist/jquery.magnific-popup":6,"./_bower/owl.carousel/dist/owl.carousel":7,"jquery":1,"lazysizes":2,"lazysizes/plugins/bgset/ls.bgset":3,"lazysizes/plugins/parent-fit/ls.parent-fit":4,"lazysizes/plugins/respimg/ls.respimg":5}]},{},[8]);
